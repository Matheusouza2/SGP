...
<html lang="en">
  <head>
    ...
    <link id="favicon" rel="shortcut icon" type="image/png" href="imgs/Programar Software - 2019.png">
      ...
      <form action="../control/login.php" method="POST" class="needs-validation" novalidate>
        <div class="form">
          ...
          <div class="col-lg-15 mb-10">
            ...
            <input type="password" class="form-control" id="validationCustom02" placeholder="Senha" required name="senha">
