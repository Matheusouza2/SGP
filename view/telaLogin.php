			...
			<div class="form">
				<div style="margin: 5;">
					<div class="col-lg-15 mb-10">
						<label for="validationCustom01">Email</label> <input type="email" class="form-control" id="email" placeholder="Email" required name="email">
				...
				<div style="margin: 5;">
					<div class="col-lg-15 mb-10">
						<label for="validationCustom02">Senha</label> <input type="password" class="form-control" id="validationCustom02" placeholder="Senha" required name="senha">
