			...
			<form action="../control/login.php" method="POST" class="needs-validation" enctype="application/x-www-form-urlencoded" novalidate>
				<div class="form">
					<div class="col-lg-15 mb-10">
						<label for="validationCustom01">Email</label> <input type="email" class="form-control input-block nth-child" id="email" placeholder="Email" required name="email">
						<div class="valid-feedback">Tudo certo!</div>
						<div class="invalid-feedback">Email Invalido!</div>
					</div>

					<div class="col-lg-15 mb-10">
						<label for="validationCustom02">Senha</label> <input type="password" class="form-control input-block nth-child" id="validationCustom02" placeholder="Senha" required name="senha">
