...
<head>
    ...
    <link rel="stylesheet" href="assets/css/atualizarcomimagem.css"/>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <link href="assets/css/material-kit3.css" rel="stylesheet" />
...
<div id="conteudo1" style="padding-left: 3%;">

    <img src="imgs/logobranco.png" alt="logomarca" style="margin-top: 50px; margin-left: 35%;">
    
    <div style="margin-top: 5%; margin-left:15%;" class="btn-group" data-toggle="buttons">
    ...
    <div  style="margin-left: 6%; margin-top: 3%; display: none;"  id="CadastroUsuario">  
        
        <form class="form" method="POST" action="control/atualizar.php">
                    ...
                    <div style="margin-top: 5%;" class="input-group">
                        ...
                        <div style="margin-top: 5%;" class="input-group">
                            ...
                            <div style="padding-top: 5%; margin-left: 30%;" class="text-center">
                                <a  class="btn btn-primary btn-link btn-wd btn-light"  style="color: white; background: rgb(2, 3, 99);">Atualizar</a>
                        </div>
                ...
                <div  style="margin-left: 6%; margin-top: 3%; display: none;"  id="CadastroInstituição">  
                                    ...
                                    <div style="margin-top: 5%;" class="input-group">
                                        ...
                                        <div style="margin-top: 5%;" class="input-group">
                                            ...
                                            <div class="input-group-prepend">
                                                ...
                                                <input name="dataF" style="color: white; margin-right: 5%;" class="form-control col-sm-15" type="text" class="form-control" placeholder="Data de Fundação">
...
<div id="conteudo2">
        ...
        <img src="imgs/vetoratualizar.png" alt="Trulli" width="600" height="510" style="margin-top: 75px; margin-left: 23%; margin-right: 30%;">
