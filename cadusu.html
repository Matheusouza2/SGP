  ...
  <section class="form-section">
    ...
    <form action="cadUser.php" method="POST" class="needs-validation" novalidate>
      ...
      <div class="form-group">
        ...
        <div class="form-row">
          <div class="col-md-4 mb-4">
            <label for="validationCustom07">Id Professor</label>
            <input type="text" class="form-control" id="idprofessor" name="idprofessor" placeholder="Id Professor"
              required>
            <div class="valid-feedback">
              Tudo certo!
            </div>
        ...
        <div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input" id="customControlValidation1" name="curso1">
          <label class="custom-control-label" for="customControlValidation1">Sistemas p/ Internet</label>
        </div>

        <div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input form-control" id="customCheck2" name="curso2">
          <label class="custom-control-label" for="customCheck2">Fisica</label>
        </div>


        <div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input form-control" id="customCheck3" name="curso3">
          <label class="custom-control-label" for="customCheck3">Alimentos</label>
        </div>


        <div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input form-control" id="customCheck4" name="curso4">
          <label class="custom-control-label" for="customCheck4">Edificações</label>
        </div>


        <div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input form-control" id="customCheck5" name="curso5">
          <label class="custom-control-label" for="customCheck5">Agropecuária</label>
        </div>

        <div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input form-control" id="customCheck6" name="curso6">
