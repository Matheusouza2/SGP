...
class PermutaDao {
    ...
    function listarPermutaDisponivel($idProfessor){
        $con = Conexao::getInstance();
            /**-------------Cadastra a permuta------------------ */
        $sql = "SELECT DISTINCT permuta.id as permuta_id, usuario.nome as professor_nome, usuario.foto as foto, usuario.contato, usuario.email, 
